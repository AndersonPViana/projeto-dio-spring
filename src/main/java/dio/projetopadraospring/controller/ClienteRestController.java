package dio.projetopadraospring.controller;
...
public class ClienteRestController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Cliente> buscarPorId(@PathVariable Integer id) throws ChangeSetPersister.NotFoundException {
